...
library(reticulate)
use_virtualenv("C:/Users/ASUS/Documents/.virtualenvs/r-tensorflow", required = TRUE)
library(devtools)
load_all("C:/Users/ASUS/cellassign/")
...
scanvi_df <- read.csv("D/data/scanvi_labels.csv", row.names = 1)
